...
static const HangulCombinationItem hangul_replace_table_2_noshift[] = {
  { 0x1100, 0x1101 },  /* choseong (kiyeok -> ssang-kiyeok) */
  { 0x1103, 0x1104 },  /* choseong (tikeut -> ssang-tikeut) */
  { 0x1107, 0x1108 },  /* choseong (pieup -> ssang-peup) */
  { 0x1109, 0x110A },  /* choseong (sios -> ssang-sios) */
  { 0x110c, 0x110d },  /* choseong (cieuc -> ssang-cieuc) */
